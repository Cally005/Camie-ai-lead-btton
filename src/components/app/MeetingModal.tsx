...
//       {isOpen && (
//         <div className={`fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 ${
//         chatTheme === "dark" ? "dark-mode bg-gray-900 text-white" : "light-mode bg-white text-gray-900"
//       }`}
//     >
//         <div className="bg-white p-8 rounded-lg w-full max-w-3xl relative">
//             <div className="flex justify-between items-center">
//               <h2 className="text-xl font-semibold">Book a Meeting</h2>
//               <button onClick={closeModal} className={`text-gray-600 text-xl${
//             chatTheme === "dark" ? "dark-close-button" : "light-close-button"
//           }`}>
//                 &times;
//               </button>
//             </div>
...
//                 className="rounded-lg"
//                 style={{ 
//                   colorScheme: chatTheme === "dark" ? "dark" : "light" 
//                 }}
//               ></iframe>
//             </div>
//           </div>
